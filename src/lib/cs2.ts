 ...
 * daqui guarda a fase no nome, porque para quem sorteia ela é parte do
 * prêmio, e 182 das 865 skins cadastradas são assim.
 *
 * Sem esta ponte, o painel pergunta à Steam por um item que não existe,
 * recebe "não tenho anúncio", e a cota nasce no valor padrão. Foi assim que
 * uma campanha nasceu com cota de R$ 1,00.
 */
...
/**
 * Separa "★ Bowie Knife | Gamma Doppler Emerald" no nome e na fase.
 *
