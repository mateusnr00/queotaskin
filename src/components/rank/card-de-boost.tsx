  ...
  return (
    <section className="rounded-lg border border-[#232730] bg-[#141619] p-5">
              ...
              >
                ...
                <span
                  className={cn(
                    ...
                    alcancada ? "text-foreground" : "text-muted-foreground/60",
                  )}
                >
      ...
      <dl className="mt-4 grid grid-cols-2 gap-3 border-t border-[#232730] pt-4 text-xs sm:grid-cols-4">
        ...
        <Numero rotulo="Sequência" valor={`${dados.sequencia} dia${dados.sequencia === 1 ? "" : "s"}`} />
        <Numero rotulo="Melhor sequência" valor={`${dados.recorde}`} />
        <Numero rotulo="Dias ativos no ciclo" valor={`${dados.diasAtivosNoCiclo}`} />
      </dl>
      ...
      <details className="mt-4 border-t border-[#232730] pt-3">
        ...
        <div className="mt-2 space-y-2 text-xs leading-relaxed text-muted-foreground">
          <p>
            ...
            quantidade recebida. Seu multiplicador pode variar ao longo do tempo
          ...
          <p>
            Os multiplicadores aumentam somente o XP recebido e não alteram suas
            chances nos sorteios.
          </p>
        </div>
      </details>
    </section>
